            ...
            <div>
              ...
              <blockquote>
                <p className="font-medium text-xl text-white md:text-2xl  md:leading-normal xl:text-xl xl:leading-normal">
                  ...
                  React.js, Redux, Node.js, Express.js, and MongoDB. Proficient
                  in building scalable, high-performance web applications with a
                  strong focus on responsiveness and user experience.
                  Experienced in deploying applications seamlessly on platforms
                  like Netlify, Vercel, and Render.
                </p>
